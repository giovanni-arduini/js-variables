...
const cityIndex = city.indexOf("Y", -1);
console.log(cityIndex); // Output: 4

// 2. Sottostringhe
// Stampa la sottostringa "York" dalla variabile city
const citySubstring = city.slice(4, 8);
console.log("I caratteri dal quarto all'ottavo sono: ", citySubstring); // Output: "York"

// 3. Sostituzione
// Sostituisci 'York' con 'Delhi'
const cityReplaced = city.replace("New York", "New Delhi");
console.log("New York viene sostituito da: ", cityReplaced); // Output:  "New Delhi"
...
console.log("Hello viene riscritto in uppercase: ", upperCaseHello); // Output: "HELLO"
